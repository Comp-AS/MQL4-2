...
/////////////////////////
    ...
    for(int i=limit-1; i >=0; i--)
    {
      ...
      if((C_4 < O_4) && (C_3 < O_3) && (C_2 < O_2) && (C_3 < O_4) && (C_2 < O_3) && (C_1 > O_4))
         
      {
         CrossUp[i+1] = Low[i+1];
         Alerts(buyNow);
      }
      else if((C_4 > O_4) && (C_3 > O_3) && (C_2 > O_2) && (C_3 > O_4) && (C_2 > O_3) && (C_1 < O_4))
      {
         CrossDown[i+1] = High[i+1];
         Alerts(sellNow);
      }
         
      if((C_3 < O_3) && (C_2 < O_2) && (C_2 < O_3) && (C_1 > O_3) && (C_1 < O_4))
         
      {
         CrossUpx[i+1] = Low[i+1];
         Alerts(buyNow);
      }
      else if((C_3 > O_3) && (C_2 > O_2) && (C_2 > O_3) && (C_1 < O_3) && (C_1 > O_4))
      {
