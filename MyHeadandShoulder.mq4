    ...
    */
    ...
    for(int i=limit-1; i >=0; i--)
    {
      ...
      */
      ...
      z[11] = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 1, i+11);
      z[12] = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 1, i+12);
      z[13] = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 1, i+13);
      ...
      */
      /*
      z1 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+1);
      z2 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+2);
      z3 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+3);
      z4 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+4);
      z5 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+5);
      z6 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+6);
      z7 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+7);
      z8 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+8);
      z9 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+9);
      z10 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+10);
      z11 = iCustom(Symbol(), 0, "ZigZag", CalculateOnBarClose, ZZDepth, ZZDev, 0, i+11);
...
*/
      ...
      */
      ...
      zMaxIndex = ArrayMaximum(z, WHOLE_ARRAY, 0);
      maxLeftIndex = ArrayMaximum(z, (240 - zMaxIndex), (zMaxIndex + 1));
      maxRightIndex = ArrayMaximum(z, (zMaxIndex - 1), 0);
      maxTroughLeftIndex = ArrayMinimum(z, (maxLeftIndex - zMaxIndex), zMaxIndex+1);
      maxTroughRightIndex = ArrayMinimum(z, (zMaxIndex - maxRightIndex), maxRightIndex+1);
    
      zMinIndex = ArrayMinimum(z, WHOLE_ARRAY, 0);
      minLeftIndex = ArrayMinimum(z, (100 - zMinIndex), (zMinIndex + 1));
      minRightIndex = ArrayMinimum(z, (zMinIndex - 1), 0);
      minTroughLeftIndex = ArrayMaximum(z, (minLeftIndex - zMinIndex), zMinIndex+1);
      minTroughRightIndex = ArrayMaximum(z, (zMinIndex - minRightIndex), minRightIndex+1);
      ...
      else if((zMaxValue != 0.0 && maxLeftValue != 0.0 && maxRightValue != 0.0 && maxTroughLeftIndex != 0.0 && maxTroughRightIndex != 0.0) &&
